...
<div class="container">
	<div class="d-flex justify-content-center">
		<div class="d-flex flex-column" style="width:600px;">
			<div>
				<button type="button" class="btn btn-outline-secondary"  onclick="location.href='/user/idfind'">아이디 찾기</button>
				<button type="button" class="btn btn-outline-primary active" data-bs-toggle="button"  aria-pressed="true" onclick="location.href='/user/pwfind'">비밀번호 찾기</button>
				<div class="border border-primary"></div>
			</div>
			<br>
			<div>
			<!-- onsubmit="findPw(event)" -->
				<form > 
				<div class="mb-3 mt-3 d-flex justify-content-center ">
					<div class="d-flex flex-column">
						<label for="name">아이디:</label> 
						<input type="text" class="form-control" id="username" placeholder="아이디를 입력해주세요." required="required"  style="width:400px;">
					</div>
				</div>
				<br>
				<div class="mb-3 mt-3 d-flex justify-content-center">
				...
				<div class="d-flex justify-content-center">
					<div id="loading"></div>
					<button type="button" class="btn btn-primary" onclick="findPw(event)">&emsp;찾기&emsp;</button>
...
<script>
	async function findPw(event) {
		...
		let response = await fetch("http://localhost:8080/user/pw", {
			method: "post",
		...
		console.log(parseResponse);
			...
			if(parseResponse.code == 1) { // ajax는 자바스크립트에서 분기 시켜줘야 한다
				...
				$(".modal-title").text("비밀번호 찾기 완료");
				$(".modal-body").text("등록된 이메일 주소로 비밀번호가 전송되었습니다.");
